...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PLL3.PLL3FRACN = 5411;
...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ByPass_Pin|SSPI_DATA_Pin|AUDIO_MUTE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, TFT_Reset_Pin|SSPI_CS_Pin|SSPI_CLK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Encoder3_B_Pin Encoder3_A_Pin Encoder1_B_Pin Encoder1_A_Pin
                           Encoder1_SW_Pin Encoder0_B_Pin Encoder0_A_Pin Encoder0_SW_Pin */
  GPIO_InitStruct.Pin = Encoder3_B_Pin|Encoder3_A_Pin|Encoder1_B_Pin|Encoder1_A_Pin
                          |Encoder1_SW_Pin|Encoder0_B_Pin|Encoder0_A_Pin|Encoder0_SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  /*Configure GPIO pin : Encoder3_SW_Pin */
  GPIO_InitStruct.Pin = Encoder3_SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(Encoder3_SW_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SSPI_CS_Pin SSPI_CLK_Pin */
  GPIO_InitStruct.Pin = SSPI_CS_Pin|SSPI_CLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : SSPI_DATA_Pin */
  GPIO_InitStruct.Pin = SSPI_DATA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(SSPI_DATA_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : AUDIO_MUTE_Pin */
  GPIO_InitStruct.Pin = AUDIO_MUTE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(AUDIO_MUTE_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : FootSwitch2B_Pin */
  GPIO_InitStruct.Pin = FootSwitch2B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(FootSwitch2B_GPIO_Port, &GPIO_InitStruct);
